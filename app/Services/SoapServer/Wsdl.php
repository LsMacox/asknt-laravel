...
use DOMNode;
use DOMXPath;
use App\Services\SoapServer\Wsdl\ComplexTypeStrategy\ComplexTypeStrategyInterface as ComplexTypeStrategy;
use Laminas\Uri\Uri;
use App\Services\SoapServer\Wsdl\ComplexTypeStrategy\DefaultComplexType;
...
class Wsdl
{
    ...
    protected function getDOMDocument($name, $uri = null)
    {
        ...
        $definitions = $dom->createElementNS(self::WSDL_NS_URI, self::WSDL_NS.':'.'definitions');
